 ...
 * 
 * import com.example.ChatApp.Services.JWTService; import
 * com.example.ChatApp.Services.UserService;
 * 
 ...
 * ServletException, IOException { final String authHeader =
 * request.getHeader("Authorization"); final String jwt; final String userEmail;
 * if (StringUtils.isEmpty(authHeader) ||
 * !org.apache.commons.lang3.StringUtils.startsWith(authHeader, "Bearer")) {
 * filterChain.doFilter(request, response); return; } jwt =
 ...
 * if (jwtService.isTokenValid(jwt, userDetails)) { SecurityContext
 * securityContext = SecurityContextHolder.createEmptyContext();
 * 
 * UsernamePasswordAuthenticationToken token = new
 * UsernamePasswordAuthenticationToken(userDetails, null,
 * userDetails.getAuthorities()); token.setDetails(new

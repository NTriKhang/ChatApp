 ...
 * 
 * import com.example.ChatApp.Models.Users; import
 ...
 * userdetails.DaoAuthenticationConfigurer; import
 ...
 * .authorizeHttpRequests( requet ->
 * requet.requestMatchers("/api/v1/auth/**").permitAll().anyRequest().
